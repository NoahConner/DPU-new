...
$menu_links = array(
    ...
    */
    ...
    array("title" => "Layout", "icon" => "clip-screen", "action" => array("promotional_banner", "testimonial", "cms_page", "cms_title", "logo"),
        "additionals" => array(
            ...
            //array("link" => "cms_title", "title" => "CMS Title", "icon" => "speech"),
    ...
    //     "additionals" => array(
    //         array("link" => "banner", "title" => "Banner", "icon" => " fa fa-picture-o"),
...
// Testimonials
    ...
    */
    ...
    array("title"=>"Blog Management", "icon"=>" fa fa-circle-o-notch" ,"action" => array("blog_category","blog","comment") ,
         "additionals"=>array(
             ...
             array("link"=>"blog","title"=>"Manage Blog", "icon"=>"fa fa-newspaper-o"),
   ...
   /* array("title"=>"News", "icon"=>" fa fa-newspaper-o" ,"action" => array("news") ,
    ...
    /*array("title"=>"Video", "icon"=>" fa fa-play-circle" ,"action" => array("video") ,
        "additionals"=>array(
            array("link"=>"video","title"=>"Video", "icon"=>" fa fa-question-circle-o
"),
        ),
    ),*/
    /*array("title"=>"FAQ", "icon"=>" fa fa-question-circle-o
" ,"action" => array("faq") ,
        "additionals"=>array(
...
//     array("title"=>"Help", "icon"=>" fa fa-question-circle-o
// " ,"action" => array("help") ,
//         "additionals"=>array(
//             array("link"=>"help","title"=>"Help", "icon"=>" fa fa-question-circle-o
// "),
//         ),
//     ),

//     array("title"=>"Inventory", "icon"=>"clip-transfer" ,"action" => array("category","product","pricing","prep_size", "exam", "exam_list", "brand","style", "comment", "color") ,
//         "additionals"=>array(
...
//             array("link"=>"category","title"=>"Category", "icon"=>" fa fa-folder-open"),
//             array("link"=>"product","title"=>"Product", "icon"=>"basket"),
//             array("link"=>"product_flash_sale","title"=>"Product Flash Sale", "icon"=>"basket"),
// //            array("link"=>"comment","title"=>"Comment", "icon"=>" fa fa-comment-o"),
...
//     ),
    ...
    /*array("title"=>"Order Management", "icon"=>" fa fa-shopping-basket" ,"action" => array("order") ,
        "additionals"=>array(
...
"),
    ...
    array("title" => "Inquiries", "icon" => "fa fa-envelope-o", "action" => array("inquiry", "inform_restock", "newsletter", "event_subscribe", "subscribe", "quote"), "link"=>"inquiry",
        "additionals" => array(
            ...
            //array("link"=>"subscribe","title"=>"Subscriber", "icon"=>"envelope"),
