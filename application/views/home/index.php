      ...
      <div class="row desktopGrid">
        <div class="col-sm-4 animate bounceIn" data-wow-delay="0.5s">
          <div class="bx">
            <div class="icon-wrapper">
              <div class="circle">
                <svg style="filter: drop-shadow(4px 5px 4px rgba(255,167,5,0.3)); fill: #ffa705;" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 177.4 197.4"><path d="M0,58.4v79.9c0,6.5,3.5,12.6,9.2,15.8l70.5,40.2c5.6,3.2,12.4,3.2,18,0l70.5-40.2c5.7-3.2,9.2-9.3,9.2-15.8V58.4 c0-6.5-3.5-12.6-9.2-15.8L97.7,2.4c-5.6-3.2-12.4-3.2-18,0L9.2,42.5C3.5,45.8,0,51.8,0,58.4z"></path></svg>
              </div>
              <div class="circle">
                <svg style="filter: drop-shadow(4px 5px 4px rgba(255,86,0,0.3)); fill: #ff5600;" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 177.4 197.4"><path d="M0,58.4v79.9c0,6.5,3.5,12.6,9.2,15.8l70.5,40.2c5.6,3.2,12.4,3.2,18,0l70.5-40.2c5.7-3.2,9.2-9.3,9.2-15.8V58.4 c0-6.5-3.5-12.6-9.2-15.8L97.7,2.4c-5.6-3.2-12.4-3.2-18,0L9.2,42.5C3.5,45.8,0,51.8,0,58.4z"></path></svg>
              </div>
              <figure>
        ...
        <div class="col-sm-4 animate bounceIn" data-wow-delay="0.5s">
          <div class="bx">
            <div class="icon-wrapper">
              <div class="circle">
                <svg style="filter: drop-shadow(4px 5px 4px rgba(65,193,123,0.3)); fill: #41c17b;" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 177.4 197.4"><path d="M0,58.4v79.9c0,6.5,3.5,12.6,9.2,15.8l70.5,40.2c5.6,3.2,12.4,3.2,18,0l70.5-40.2c5.7-3.2,9.2-9.3,9.2-15.8V58.4 c0-6.5-3.5-12.6-9.2-15.8L97.7,2.4c-5.6-3.2-12.4-3.2-18,0L9.2,42.5C3.5,45.8,0,51.8,0,58.4z"></path></svg>
              </div>
              <div class="circle">
                <svg style="filter: drop-shadow(4px 5px 4px rgba(0,153,69,0.3)); fill: #009945;" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 177.4 197.4"><path d="M0,58.4v79.9c0,6.5,3.5,12.6,9.2,15.8l70.5,40.2c5.6,3.2,12.4,3.2,18,0l70.5-40.2c5.7-3.2,9.2-9.3,9.2-15.8V58.4 c0-6.5-3.5-12.6-9.2-15.8L97.7,2.4c-5.6-3.2-12.4-3.2-18,0L9.2,42.5C3.5,45.8,0,51.8,0,58.4z"></path></svg>
              </div>
              <figure>
        ...
        <div class="col-sm-4 animate bounceIn" data-wow-delay="0.5s">
          <div class="bx">
            <div class="icon-wrapper">
              <div class="circle">
                <svg style="filter: drop-shadow(4px 5px 4px rgba(86,189,253,0.3)); fill: #56bdfd;" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 177.4 197.4"><path d="M0,58.4v79.9c0,6.5,3.5,12.6,9.2,15.8l70.5,40.2c5.6,3.2,12.4,3.2,18,0l70.5-40.2c5.7-3.2,9.2-9.3,9.2-15.8V58.4 c0-6.5-3.5-12.6-9.2-15.8L97.7,2.4c-5.6-3.2-12.4-3.2-18,0L9.2,42.5C3.5,45.8,0,51.8,0,58.4z"></path></svg>
              </div>
              <div class="circle">
                <svg style="filter: drop-shadow(4px 5px 4px rgba(58,68,237,0.3)); fill: #3a44ed;" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 177.4 197.4"><path d="M0,58.4v79.9c0,6.5,3.5,12.6,9.2,15.8l70.5,40.2c5.6,3.2,12.4,3.2,18,0l70.5-40.2c5.7-3.2,9.2-9.3,9.2-15.8V58.4 c0-6.5-3.5-12.6-9.2-15.8L97.7,2.4c-5.6-3.2-12.4-3.2-18,0L9.2,42.5C3.5,45.8,0,51.8,0,58.4z"></path></svg>
              </div>
              <figure>
