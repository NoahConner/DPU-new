...
class Model_portfolio extends MY_Model {
    ...
    function __construct()
    {
        ...
        $this->pagination_params['fields'] = "portfolio_id,portfolio_type,
        CONCAT(portfolio_image_path,portfolio_thumb_image) AS portfolio_thumb_image,
        ...
        $fields = array(
              ...
              'portfolio_image' => array(
                ...
                'portfolio_thumb_image' => array(
                     ...
                     'randomize' => true,
                     'preview'   => 'true',
                     'attributes'   => array('image_size'=>'Recommended image size : 446px × 283px','allow_ext'=>'png|jpeg|jpg',),
                     'dt_attributes'   => array("width"=>"10%"),
                     'rules'   => 'trim|htmlentities',
                     'js_rules'=>$is_required_image
                  ),
