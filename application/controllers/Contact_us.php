    ...
    public function quote()
    {
        ...
        if (count($_POST) > 0) {
            if ($this->validate("model_quote")) {
                $form_name = 'quote';
                $contact_us_data = $_POST['quote'];
                $contact_us_data['quote_interested'] = implode($contact_us_data['quote_interested'], ', ');
                //$contact_us_data['quote_type'] = 'contactus';
                $contact_us_data['quote_status'] = 1;

                $inserted_id = $this->model_quote->insert_record($contact_us_data);
                // $this->model_quote->set_attributes($contact_us_data);
