...
class MY_Controller extends MY_Controller_Admin
{
    ...
    public function __construct()
    {
        ...
        if ($this->router->directory == "admin/") {
            ...
            if (isset($this->session->userdata['userdata']))
            {
                ...
                $this->user_type = $this->session->userdata['userdata']['signup_type'];
        ...
        $home_data = $this->model_seo_plugin->find_by_pk($this->seo_id);
        $this->layout_data['title'] = $home_data['sp_meta_title'];
        $this->layout_data['meta_data']['keywords'] = $home_data['sp_meta_keywords'];
        $this->layout_data['meta_data']['description'] = $home_data['sp_meta_description'];
       ...
       public function client_email ($to,$template,$title)
   {
    ...
    $name = g('site_name').'  NewsLetter';
    $send_to = $to;$title = $name;
    $message = $template;
